...
public interface UserController { 
    ...
    ResponseEntity<String> register(@RequestBody @Valid RegisterUserDTO registerData, UriComponentsBuilder uriBuilder);
    ...
    ResponseEntity<Page<UserMonitoringDTO>> findAll(@PageableDefault(sort = "email", direction = Sort.Direction.ASC, size = 12)
    ...
    ResponseEntity<UserMonitoringDTO> findById(@PathVariable String id);
